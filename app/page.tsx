            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
              <div className="flex flex-col justify-center space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  >
                    <Link href="https://api.whatsapp.com/send/?phone=5516997898401&text&type=phone_number&app_absent=0" className="flex items-center">
                      Agendar Demonstração
          ...
          <div className="container px-4 md:px-6 relative z-10">
            ...
            <div className="mx-auto max-w-5xl py-6">
              ...
              <div className="grid gap-8 md:grid-cols-3">
                ...
                <div className="rounded-lg bg-gradient-to-b from-[#0f172a] to-[#070b14] border border-[#1e293b] p-6 relative overflow-hidden group hover:shadow-2xl hover:hover:shadow-[#4f46e5]/10 transition-all duration-300 shadow-xl shadow-[#4f46e5]/5">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#4f46e5]/5 to-transparent"></div>
                  <div className="absolute inset-0 bg-gradient-to-t from-[#4f46e5]/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <div className="relative z-10 flex flex-col h-full">
                    <div className="mb-6 h-16 flex items-center justify-center">
